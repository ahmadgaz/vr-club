...
export default function StarBorderText() {
  return (
    <div className="relative w-full">
      <div className="absolute -left-10 -top-16 h-[500px] w-full">
        ...
        <div className="absolute  right-1 top-[4.5rem] h-[2px] w-[95%] border-t-[1px] border-[#E1E0E2]"></div>
        <div className="absolute right-0 top-[5rem] h-[2px] w-[98%] border-t-[1px] border-[#E1E0E2]"></div>
      </div>
      <Image
        src={assets.starIcon}
        alt="star"
